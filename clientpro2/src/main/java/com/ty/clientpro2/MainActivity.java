...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btn_bind) {
            ...
            try {
                ...
                mTvInfo.append("Cannot communicate with service \n");
            }
        } else if (v.getId() == R.id.btn_minus) {
            try {
                mService.minus(22, 22);
            } catch (RemoteException e) {
                mTvInfo.append("Cannot communicate with service \n");
            };
        } else if (v.getId() == R.id.btn_multiply) {
            try {
                mService.multiply(33, 33);
            } catch (RemoteException e) {
                mTvInfo.append("Cannot communicate with service \n");
            }
        } else if (v.getId() == R.id.btn_divide) {
            try {
                mService.divide(44, 44);
            } catch (RemoteException e) {
                mTvInfo.append("Cannot communicate with service \n");
            }
        }
    ...
    private void bind() {
        if (mService == null) {
            ...
            intent.putExtra("client_name", "ClientPro2");
            intent.putExtra("service_name", "Service2");
